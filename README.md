...
## Thanks
thanks to https://github.com/juho-lee/set_transformer for its set_transformer.
thanks to https://github.com/qcappart/hybrid-cp-rl-solver for its RL code architecture.