"""
common greedy algorithm for submodule optimization.
if the best value didn't change for a whole round,
we can let the calculation over. Because it is submodule.
change list to np.array to reduce calculation time
"""
